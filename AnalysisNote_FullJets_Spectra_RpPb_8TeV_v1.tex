...
The selected jet \pT range for \pPb collisions is 20 - 240 GeV/c for all jet radii (R = 0.2 - 0.5):
...
The rho sparse or "CMS" method of background subtraction is used in this analysis to subtract the underlying event. This method was also used in \cite{anaNoteHHassan}, where more information about it can be found in section 4.1.
...
The jet spectra in \pp are compared to calculations done in the framework of PYTHIA8.
